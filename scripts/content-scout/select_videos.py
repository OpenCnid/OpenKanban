...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--channels",
        default="config/content-scout/channels.json",
        help="Path to channels JSON config",
    )
    parser.add_argument(
        "--keywords",
        default="config/content-scout/keywords.json",
...
def main() -> int:
    ...
    scoring_payload = load_json(resolve_path("config/content-scout/settings.json"), default={})
